...
#OPÇÃO 2 - A PRAZO PARCELADO EM ATE 6X
elif forma == 2:
    parcelas  = int(input("Digite a quantidade de parcelas (atr 6x): "))

    if parcelas < 1 or parcelas > 6:
        print("Erro! só pode parcelar em ate 6 vezes.")
        ...
        print(f"Total a prazo: R$ {produto:.2f}")
